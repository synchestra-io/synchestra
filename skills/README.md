...
| [synchestra-task-release](synchestra-task-release/README.md) | Release a claimed task back to pending | [task release](../spec/features/cli/task/release/README.md) |
