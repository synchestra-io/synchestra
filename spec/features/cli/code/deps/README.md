...
Shows the Synchestra resources (features, plans, docs) that source files depend on. Scans source files for [source references](https://github.com/specscore/specscore/blob/main/spec/features/source-references/README.md) — `synchestra:` annotations and expanded `https://synchestra.io/` URLs in comments — and lists the referenced resources.
...
2. Scan matched files for source references using the [comment-prefix detection rule](https://github.com/specscore/specscore/blob/main/spec/features/source-references/README.md#detection-strategy)
