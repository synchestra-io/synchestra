...
1. Validate arguments: `--title` is required; slug (if provided) must be lowercase, hyphen-separated, and URL-safe per the [feature structural rules](https://github.com/specscore/specscore/blob/main/spec/features/feature/README.md)
