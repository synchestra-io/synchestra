...
**Skill:** [synchestra-feature-deps](../../../../../skills/synchestra-feature-deps/README.md)
...
5. Output each dependency as a feature ID, one per line, sorted alphabetically
...
- Should there be a `--recursive` flag to show transitive dependencies (dependencies of dependencies)?
