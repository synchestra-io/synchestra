...
| `code-annotations` | Go source files | Integration points should include `// Features implemented:` and `// Features depended on:` annotations (per [source-references](https://github.com/specscore/specscore/blob/main/spec/features/source-references/README.md) convention) |
