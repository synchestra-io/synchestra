...
| [plan](https://github.com/specscore/specscore/blob/main/spec/features/plan/README.md) | Gates trigger on plan status transitions |
| [feature](https://github.com/specscore/specscore/blob/main/spec/features/feature/README.md) | `_config.yaml` for feature-scoped role overrides (planned addition to feature spec's reserved `_` prefix table) |
