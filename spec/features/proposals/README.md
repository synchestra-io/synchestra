...
An approved proposal is a trigger for [plan](https://github.com/specscore/specscore/blob/main/spec/features/plan/README.md) creation. When a plan is created from a proposal:
