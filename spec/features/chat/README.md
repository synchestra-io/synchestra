...
| Feature | Interaction |
|---|---|
| [Feature](https://github.com/specscore/specscore/blob/main/spec/features/feature/README.md) | Chats anchor to features. "Create Feature" workflow produces new feature specs. |
...
| [Plan](https://github.com/specscore/specscore/blob/main/spec/features/plan/README.md) | Standard-path chats produce artifacts that later trigger plans. Fast-path chats produce plans as reports. Chats can anchor to existing plans for discussion. |
