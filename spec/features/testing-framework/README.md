...
| Executable without tooling translation | No (needs step definitions in code) | No (needs a runner that maps keys to actions) | Yes (bash blocks run directly) |
