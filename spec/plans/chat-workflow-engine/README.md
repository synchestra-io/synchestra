...
Build the loader that reads project-level workflow customizations from `synchestra-project.yaml` and merges them with the built-in workflow definitions.
...
**Acceptance criteria:**
- Reads `workflows:` section from `synchestra-project.yaml`
