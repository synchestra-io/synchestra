...
- [CLI: `synchestra task update`](https://github.com/synchestra-io/synchestra-go/blob/main/docs/cli/task.md#update)
- [CLI: `synchestra rule`](https://github.com/synchestra-io/synchestra-go/blob/main/docs/cli/rule.md)
