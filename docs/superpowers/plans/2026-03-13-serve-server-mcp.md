...
- `synchestra-spec-repo.yaml` — spec repo
- `synchestra-state-repo.yaml` — state repo
...
2. Traverse up to find `synchestra-server.yaml`, `synchestra-spec-repo.yaml`, or `synchestra-state-repo.yaml`
